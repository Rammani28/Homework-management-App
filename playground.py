...
# homework = {
#     "science": {
#         "description": "study about Microbes",
#         "due_date": "24/05/2023",
#         "completed": False,
#         "id": 186,
#         "show": True
...
#     due_date = datetime.strptime(details["due_date"], "%d/%m/%Y")
#     details["due_date"] = due_date
#
# sorted_subjects = sorted(homework.keys(), key=lambda x: homework[x]["due_date"], reverse=True)
#
# for subject in sorted_subjects:
#     print(f"{subject}: {homework[subject]['due_date'].strftime('%d/%m/%Y')}")
...
#
# for subject in sorted_subjects:
#     print(f"{subject}: {homework[subject]['due_date']}")
